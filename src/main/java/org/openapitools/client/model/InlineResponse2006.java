...
public class InlineResponse2006 {
  ...
  public InlineResponse2006 data(List<Users> data) {
    this.data = data;
    return this;
  }

  public InlineResponse2006 addDataItem(Users dataItem) {
    if (this.data == null) {
   ...
   * @return data
  **/
  @ApiModelProperty(value = "Display the list of users in a group")
  ...
  public InlineResponse2006 meta(Metadata meta) {
    this.meta = meta;
    return this;
  }
