...
public class InlineResponse200 {
  ...
  private List<Comments> data = new ArrayList<Comments>();

  public static final String SERIALIZED_NAME_META = "meta";
  @SerializedName(SERIALIZED_NAME_META)
  private Metadata meta = null;

  public InlineResponse200 data(List<Comments> data) {
    this.data = data;
    return this;
  }

  public InlineResponse200 addDataItem(Comments dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public InlineResponse200 meta(Metadata meta) {
    this.meta = meta;
    return this;
  }
