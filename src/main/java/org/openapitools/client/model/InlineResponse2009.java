...
public class InlineResponse2009 {
  ...
  public InlineResponse2009 data(List<GroupMembers> data) {
    this.data = data;
    return this;
  }

  public InlineResponse2009 addDataItem(GroupMembers dataItem) {
    if (this.data == null) {
   ...
   * @return data
  **/
  @ApiModelProperty(value = "Display a listing of users available")
  ...
  public InlineResponse2009 meta(Metadata meta) {
    this.meta = meta;
    return this;
  }
