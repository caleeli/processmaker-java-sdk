...
public class InlineResponse2005 {
  ...
  private List<Groups> data = new ArrayList<Groups>();

  public static final String SERIALIZED_NAME_META = "meta";
  @SerializedName(SERIALIZED_NAME_META)
  private Metadata meta = null;

  public InlineResponse2005 data(List<Groups> data) {
    this.data = data;
    return this;
  }

  public InlineResponse2005 addDataItem(Groups dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public InlineResponse2005 meta(Metadata meta) {
    this.meta = meta;
    return this;
  }
