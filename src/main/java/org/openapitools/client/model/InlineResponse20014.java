...
public class InlineResponse20014 {
  ...
  private List<ProcessRequest> data = new ArrayList<ProcessRequest>();

  public static final String SERIALIZED_NAME_META = "meta";
  @SerializedName(SERIALIZED_NAME_META)
  private Metadata meta = null;

  public InlineResponse20014 data(List<ProcessRequest> data) {
    this.data = data;
    return this;
  }

  public InlineResponse20014 addDataItem(ProcessRequest dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<ProcessRequest>();
    }
  ...
  **/
  ...
  public List<ProcessRequest> getData() {
    return data;
  }

  public void setData(List<ProcessRequest> data) {
    this.data = data;
  }

  public InlineResponse20014 meta(Metadata meta) {
    this.meta = meta;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.data, inlineResponse20014.data) &&
        Objects.equals(this.meta, inlineResponse20014.meta);
  }
